...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2023 at 08:50 AM
...
INSERT INTO `locations` (`location_id`, `location_name`, `address`, `city`, `state`, `zipcode`, `category_id`, `creator_admin_id`, `last_editor_admin_id`, `last_updated`) VALUES
(1, 'The 440 Club', '440 Indiana Avenue', 'Indianapolis', 'IN', '46203', 1, 1, 2, '2023-03-29 04:08:19'),
(2, 'Indiana Avenue Marker', '307 Indiana Ave', 'Indianapolis', 'IN', '46203', 1, 1, 1, '2023-03-29 04:08:19'),
(3, 'Senate Avenue YMCA', '420 North Senate Avenue', 'Indianapolis', 'IN', '46203', 2, 1, 1, '2023-03-29 04:08:19'),
(4, 'Phyllis Wheatley YWCA ', '653 North West Street ', 'Indianapolis', 'IN', '46201', 3, 1, 2, '2023-03-29 04:08:19'),
(5, 'Crispus Attucks 1955 Basketball Championship Parade Stop', 'West and Indiana Ave', 'Indianapolis', 'IN', '46203', 3, 1, 1, '2023-03-29 04:08:19'),
(6, 'Madam C.J. Walker''s Salon', '729 Indiana Avenue ', 'Indianapolis', 'IN', '46201', 4, 2, 2, '2023-03-29 04:08:19'),
(7, 'Willis Mortuary Site ', '632 Dr. Martin Luther King Jr. St. ', 'Indianapolis', 'IN', '46201', 4, 2, 1, '2023-03-29 04:08:19'),
(8, 'Hook''s Drug Store', '550 Indiana Avenue ', 'Indianapolis', 'IN', '46201', 4, 2, 2, '2023-03-29 04:08:19'),
(9, 'Ward’s Sanitarium and Nurses’ Training School', '729 Indiana Avenue ', 'Indianapolis', 'IN', '46201', 5, 2, 1, '2023-03-29 04:08:19'),
(10, 'Second Baptist Church', '422 West Michigan Street', 'Indianapolis', 'IN', '46201', 6, 1, 2, '2023-03-29 04:08:19'),
(11, 'Bethel AME', '414 West Vermont Street', 'Indianapolis', 'IN', '46201', 6, 2, 2, '2023-03-29 04:08:19'),
(12, 'Indianapolis Urban League ', '777 Indiana Ave', 'Indianapolis', 'IN', '46201', 7, 2, 2, '2023-03-29 04:08:19'),
(13, 'Polling Place', '904 Indiana Avenue ', 'Indianapolis', 'IN', '46201', 7, 2, 2, '2023-03-29 04:08:19'),
(14, 'Walker Theatre', '617 Indiana Avenue ', 'Indianapolis', 'IN', '46201', 7, 2, 1, '2023-03-29 04:08:19'),
(15, 'Ransom Place', '706 W. St. Clair St.', 'Indianapolis', 'IN', '46201', 8, 1, 1, '2023-03-29 04:08:19'),
(16, 'IUPUI / Displacement', '515 North Blackford Street', 'Indianapolis', 'IN', '46202', 8, 2, 1, '2023-03-29 04:08:19'),
(17, 'Indianapolis Recorder Building', '518 Indiana Avenue ', 'Indianapolis', 'IN', '46202', 9, 1, 2, '2023-03-29 04:08:19');
...
--
ALTER TABLE `chapters`
  MODIFY `chapter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
--
